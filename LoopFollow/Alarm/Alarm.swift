...
extension AlarmType {
    ...
    var blurb: String {
        switch self {
        case .low: return "血糖低于阈值时报警。"
        case .high: return "血糖高于阈值时报警。"
        case .fastDrop: return "血糖快速下降。"
        case .fastRise: return "血糖快速上升。"
        case .missedReading: return "X 分钟内无 CGM 数据。"
        case .iob: return "活性胰岛素过高。"
        case .cob: return "活性碳水过高。"
        case .missedBolus: return "摄入碳水但未注射。"
        case .futureCarbs: return "未来碳水到时提醒。"
        case .recBolus: return "已下发建议注射量。"
        case .battery: return "手机电量低。"
        case .batteryDrop: return "电量快速下降。"
        case .pump: return "储药器液位低。"
        case .pumpBattery: return "泵电量低。"
        case .pumpChange: return "需更换泵。"
        case .sensorChange: return "需更换探头。"
        case .notLooping: return "Loop 未完成循环。"
        case .buildExpire: return "App 版本即将过期。"
        case .overrideStart: return "临时覆盖已开始。"
        case .overrideEnd: return "临时覆盖已结束。"
        case .tempTargetStart: return "临时目标已开始。"
        case .tempTargetEnd: return "临时目标已结束。"
        case .temporary: return "一次性血糖阈值报警。"
        }
    }
}
